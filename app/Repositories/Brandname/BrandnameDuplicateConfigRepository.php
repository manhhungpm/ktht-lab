...
class BrandnameDuplicateConfigRepository extends BaseRepository
{
    /**
     * @return string
     */
    ...
    {
        return BrandnameSmsDuplicateConfig::class;
    }
...
//                $query->where('name', 'LIKE', "%$keyword%");
        ...
        if (!$counting) {
            $query->select('id', 'high_warning_from', 'high_warning_to', 'danger_warning_from', 'danger_warning_to', 'crisis_warning_from', 'crisis_warning_to', 'type_id', 'apply_from', 'apply_to', 'who_created', 'who_updated', 'when_created', 'when_updated', 'ip', 'status', 'active');
