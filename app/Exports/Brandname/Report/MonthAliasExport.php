...
class MonthAliasExport implements FromQuery, WithHeadings, ShouldAutoSize, WithEvents, WithCustomPropertiesHasFilter, WithMapping
{
    ...
    {
        return BrandnameAliasMonth::query()->where('active', ACTIVE)
            ->whereBetween('date', [$this->searchParam['time'][0], $this->searchParam['time'][1]])
            ->select('date', 'type', 'alias', '_1', '_2', '_3', '_4', '_5'
