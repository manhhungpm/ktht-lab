...
use App\Models\BrandnameDuplicateAliasDay;
...
class DuplicateDayAliasExport implements FromQuery, WithHeadings, ShouldAutoSize, WithEvents, WithCustomPropertiesHasFilter, WithMapping
{
    ...
    {
        $this->list = new BrandnameDuplicateDayAliasRepository();
        $this->searchParam = $searchParam;
    }

    public function query()
    {
        return BrandnameDuplicateAliasDay::query()->where('active', ACTIVE)
    ...
    {
        return trans('brandname.report.duplicate.alias.title_day');
    }
