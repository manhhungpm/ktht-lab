...
class DuplicateMonthSegmentExport implements FromQuery, WithHeadings, ShouldAutoSize, WithEvents, WithCustomPropertiesHasFilter, WithMapping
{
    ...
    {
        $this->list = new BrandnameDuplicateMonthSegmentRepository();
        $this->searchParam = $searchParam;
    }

    public function query()
    {
        return BrandnameDuplicateSegmentMonth::query()->where('active', ACTIVE)
    ...
    {
        return trans('brandname.report.duplicate.segment.title_month');
    }
