...
class BrandnameSmsSegmentConfigHistory extends Model
{
    protected $table = 'brandname_sms_segment_configs_history';

    protected $fillable = ['config_id','name', 'per_day', 'per_month', 'type_id', 'apply_from'
