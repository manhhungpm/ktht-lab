...
class BrandnameTimeWarningConfigHistory extends Model
{
    protected $table = 'brandname_time_warning_config_history';
    protected $fillable = ['config_id','type_id', 'apply_from', 'apply_to', 'week_day', 'time_frame', 'high_warning_from', 'high_warning_to', 'danger_warning_from'
