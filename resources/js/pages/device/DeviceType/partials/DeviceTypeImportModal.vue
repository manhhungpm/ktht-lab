<template>
    <modal
            id="modal"
            ref="modalImport"
            :title="$t('device.device_type.import')"
    ...
    >
        <div
                ...
                role="alert"
        >
            <strong>{{ $t("device.device_type.import_modal.error") }}:</strong>
            <div class="view">
                <div class="wrapper">
                    ...
                    >
                        <a href="#" style="color: white">{{
                            $t("device.device_type.import_modal.readmore")
                            }}</a>
                    </p>
                </div>
            </div>
        ...
        >
            ...
            <div class="m-alert__text">
                <strong
                >{{ $t("device.device_type.import_modal.report") }}:</strong
                >
                {{ $t("device.device_type.import_modal.import") }}<br/>
                <strong
                >{{
                    $t("device.device_type.import_modal.example_file")
                    }}:</strong
                >
                <a
                ...
                >{{ $t("device.device_type.import_modal.note") }}:</strong
                >
                <a class="m--font-danger">{{
                    $t("device.device_type.import_modal.wait_import")
                    }}</a>
            </div>
        </div>
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="file">{{
                                $t("device.device_type.import_modal.select_file")
                                }}</label>
                        </div>
                    </div>
                </div>
        ...
        methods: {
            ...
            importFile() {
                ...
                if (!vm.loadingImport) {
                    ...
                    axios
                        .post("/device/device-type/import", data, {
                            headers: {
