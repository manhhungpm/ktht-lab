<template>
    ...
    >
        <div
                ...
                role="alert"
        >
            <strong>{{ $t("admin.class.import_modal.error") }}:</strong>
            <div class="view">
                <div class="wrapper">
                    ...
                    >
                        <a href="#" style="color: white">{{
                            $t("admin.class.import_modal.readmore")
                            }}</a>
                    </p>
                </div>
            </div>
        ...
        >
            ...
            <div class="m-alert__text">
                <strong
                >{{ $t("admin.class.import_modal.report") }}:</strong
                >
                {{ $t("admin.class.import_modal.import") }}<br/>
                <strong
                >{{
                    $t("admin.class.import_modal.example_file")
                    }}:</strong
                >
                <a
                ...
                >{{ $t("admin.class.import_modal.note") }}:</strong
                >
                <a class="m--font-danger">{{
                    $t("admin.class.import_modal.wait_import")
                    }}</a>
            </div>
        </div>
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="file">{{
                                $t("admin.class.import_modal.select_file")
                                }}</label>
                        </div>
                    </div>
                </div>
