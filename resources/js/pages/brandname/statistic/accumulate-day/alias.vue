    ...
    <div>
        <div class="row">
            <div class="col-12">
                <time-range-filter
                    ...
                    :exportable="true"
                    :export-url="'/brandname/report-accumulate/alias/export'"
        ...
        <portlet :title="$t('brandname.report.report')">
            <data-table
                ref="table"
                :server-side="true"
                url="/brandname/report-accumulate/alias/listing"
                :order-type="'desc'"
                :columns="columns"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center span-cell" rowspan="2">
                            {{
                                $t(
                                    "brandname.report.accumulate.alias.table.date"
                                )
                            }}
                        </th>
                        <th class="text-center span-cell" rowspan="2">
                            {{
                                $t(
                                    "brandname.report.accumulate.alias.table.type"
                                )
                            }}
                        </th>
                        <th class="text-center span-cell" rowspan="2">
                            {{
                                $t(
                                    "brandname.report.accumulate.alias.table.alias"
                                )
                            }}
                        </th>
                        <th class="text-center span-cell" colspan="24">
                            {{
                                $t(
                                    "brandname.report.accumulate.alias.table.msg_count"
                                )
                            }}
                        </th>
                        <th class="text-right span-cell" rowspan="2">
                            {{
                                $t(
                                    "brandname.report.accumulate.alias.table.msg_total"
                                )
                            }}
                        </th>
                        <th class="text-right span-cell" rowspan="2">
                            {{
                                $t(
                                    "brandname.report.accumulate.alias.table.sub_count"
                                )
                            }}
                        </th>
                    </tr>
...
export default {
    head() {
        return {
            title: this.$t("menu.brandname.report.accumulate.alias")
        };
    },
    middleware: "auth",
    meta: {
