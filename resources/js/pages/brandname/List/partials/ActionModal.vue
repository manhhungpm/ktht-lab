    ...
    >
        ...
        >
            ...
            <div class=" col-12 form-group m-form__group label-is-selected">
                <div
                    v-for="(item, index) in form.brandname"
                    :key="item.id"
...
export default {
    ...
    methods: {
        show(ids, brandnames, isActive) {
            switch (isActive) {
                case true:
                    this.form.id = ids;
                    this.form.brandname = brandnames;
                    this.isActive = true;
                    break;
                case false:
                    this.form.id = ids;
            ...
            this.$validator.validateAll().then(result => {
                if (result) {
                    if (this.isActive) {
                        ...
                        this.disableBrandname();
                    }
                }
            });
        },
        async activeBrandname() {
