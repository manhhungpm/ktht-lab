<template>
    <modal
        ...
        :title="
            isEdit
                ? $t('brandname.config.timeframe.edit')
                : $t('brandname.config.timeframe.add')
        "
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <the-date-range
                        ...
                        :inline="false"
                        :data-vv-as="
                            $t('brandname.config.timeframe.apply_time')
                        "
                        :label="$t('brandname.config.timeframe.apply_time')"
                        :error="
                ...
                >
                    ...
                    >
                        <span>{{
                            $t("brandname.config.timeframe.approve_time")
                        }}</span>
                    </label>
                    <div class="m--margin-left-20">
                        <div class="row">
                            <label class="col-12"
                                >{{ $t("brandname.config.timeframe.time_range")
                    ...
                    >
                        {{
                            $t("brandname.config.timeframe.time_frame_required")
                        }}
                    </div>
                </div>
            </div>
    ...
    methods: {
        ...
        async add() {
            ...
            bootbox.confirm({
                ...
                message:
                    `${this.$t(
                        "brandname.config.timeframe.alert_add"
                    ...
                    `<li><b>${this.$t(
                        "brandname.config.timeframe.approve_time"
                    )} </b>:${htmlEscapeEntities(
                    ...
                    `<li><b>${this.$t(
                        "brandname.config.timeframe.apply_time"
                    )} </b>:${htmlEscapeEntities(
                    ...
                    if (result) {
                        try {
                            const res = await _this.form.post(
                                "/brandname/brandname-timeframe-config/add"
                            );
                            const { data } = res;
        ...
        async edit() {
            ...
            bootbox.confirm({
                ...
                message:
                    `${this.$t(
                        "brandname.config.timeframe.alert_edit"
                    )} <br/> <span class="text-danger"></span>` +
                    `<ul>` +
                    `<li><b>${this.$t(
                        "label.sms_group"
                ...
                callback: async function(result) {
                    if (result) {
                        try {
                            const res = await _this.form.post(
                                "/brandname/brandname-timeframe-config/edit"
                            );
                            const { data } = res;
