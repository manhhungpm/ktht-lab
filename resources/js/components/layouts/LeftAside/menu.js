            ...
            if (arrow) {
                ...
                if (
                    ...
                    if (mUtil.hasClass(submenu, "m-menu__submenu--right")) {
                        ...
                        if (mUtil.hasClass(submenu, "m-menu__submenu--pull")) {
                            if (mUtil.isRTL()) {
                                ...
                                pos =
                                    ...
                                    Math.abs(
                                        parseFloat(
                                            mUtil.css(submenu, "margin-right")
                                        )
                                    );
                            }
                        }
                        ...
                        mUtil.hasClass(submenu, "m-menu__submenu--left")
                    ) {
                        pos = mUtil.outerWidth(item) / 2;
                        if (mUtil.hasClass(submenu, "m-menu__submenu--pull")) {
                            if (mUtil.isRTL()) {
